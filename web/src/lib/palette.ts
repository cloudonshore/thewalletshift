...
// spare for a future category). The brand/primary color is pinned first so the
// dominant band (DeFi Yield) carries it.
export const BRAND = "#79c15f";

const PALETTE = [
  "#79c15f", "#553b94", "#ca8e3f", "#c77ad2", "#f0531f", "#8c2e77", "#4fc79c",
